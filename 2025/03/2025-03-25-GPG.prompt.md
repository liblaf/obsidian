...
modified: 2025-03-25T11:06:04+08:00
---
...
The `[ultimate]` in `pub ed25519/9234E2737A49D82A 2025-03-25 [SC] [ultimate]` is ownertrust. The `[ultimate]` in `uid [ultimate] liblaf <30631553+liblaf@users.noreply.github.com>` is key validity. Your own key should **both** set to `ultimate`.
